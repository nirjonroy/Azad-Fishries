...
<div class="row">
		<div class="col-md-12 col-sm-12 col-lg-12">
			<h3 class="well"> Product Update</h3>
			...
			<div class="row">
			  	<div class="col-xs-6">
				    ...
				    <div class="col-sm-10">
				      	<textarea class="form-control" name="description" placeholder="Enter Description" id="editor1" rows="10" cols="80">{{ $product->description}}</textarea>
			...
			<div class="row">
		  	...
		  	<div class="row">
		  		<div class="col-xs-6">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" placeholder="Enter Tag" name="tag" value="{{ $product->tag}}">
				      	@if($errors->has('tag'))
		  	...
		  	<div class="row">
		  		<div class="col-xs-6">
				    ...
				    <div class="col-sm-10">
				      <input type="text" class="form-control" placeholder="Enter Vedio Url" name="vedio_url" value="{{ $product->vedio_url}}">
