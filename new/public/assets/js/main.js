   ...
   var url =$(this).data('href');
    $.ajax({
        ...
        success: function(res) {     
            if (res.status) {
                $('div#exampleModalCenter').html(res.html);
...
//  add to cart
$(document).on('click',"a.uren-add_cart",function (e){
    e.preventDefault();
...
$(document).on('click',"a.uren-wishlist",function (e){
    e.preventDefault();
...
$(document).on('click',"div.qtybutton",function (e){

	e.preventDefault();
  
    var ele = $(this);
  	var url=ele.parents('td').data('href');
  	var quantity=ele.parents("td").find("input.quantity").val();
...
$("a.product-item_remove").click(function (e) {
    e.preventDefault();
